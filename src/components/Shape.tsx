  ...
  return (
    <ShapeBtn type="button" onClick={() => handler(el)} $active={current === el.value}>
      <Icon $active={current === el.value}>
        ...
        {el.value === 'sheet' && <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {el.value === 'pipe' && <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M11 20.5333C16.2651 20.5333 20.5333 16.2651 20.5333 11C20.5333 5.73489 16.2651 1.46667 11 1.46667C5.73489 1.46667 1.46667 5.73489 1.46667 11C1.46667 16.2651 5.73489 20.5333 11 20.5333ZM11 22C17.0751 22 22 17.0751 22 11C22 4.92487 17.0751 0 11 0C4.92487 0 0 4.92487 0 11C0 17.0751 4.92487 22 11 22Z" />
        </svg>}
